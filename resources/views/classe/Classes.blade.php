...
<div class="container">
    ...
    <div class="wpcf7" id="wpcf7-f156-p143-o1 formwrap">
        <form action="/classe/store" method="POST" class="wpcf7-form" novalidate="novalidate">
           @csrf
           @include('flash-message')
            <p>
               <span class="wpcf7-form-control-wrap Name">
                 <input type="text" name="class_name" value="" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required @error('class_name') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Class Name">
                 @error('class_name')
      ...
      <div id="link">
        <div style="width: 100%; height: 100%">
            <table>
                ...
                <td><a href="/classe/ViewData" value="link_2">Make Updation</a></td>
